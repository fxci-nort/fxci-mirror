  ...
  return (
    <div className="model-page__rules-container container mb-container-scroll">
      <div className="model-page__rules">
        <h2 className="section-title center">instant Model Type at FXCI</h2>
        <div className="model-page__rules-list card__1-group scroll-wrap">
          <div className="card__1-row">
            <div className="model-page__rules-item card__1">
              <img className="card__1-img" src="/img/icon-a-secureti.svg" alt="fxci" />
            ...
            <div className="model-page__rules-item card__1">
              <img className="card__1-img" src="/img/icon-a-clock-dol.svg" alt="fxci" />
          ...
          <div className="card__1-row">
            <div className="model-page__rules-item card__1">
              <img className="card__1-img" src="/img/icon-a-two-arrow.svg" alt="fxci" />
            ...
            <div className="model-page__rules-item card__1">
              <img className="card__1-img" src="/img/icon-a-close.svg" alt="fxci" />

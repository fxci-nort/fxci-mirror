        ...
        <div className="model-page__rules-list card__1-group scroll-wrap">
          <div className="card__1-row">
            <div className="model-page__rules-item card__1">
              <img className="card__1-img" src="/assets/img/icon-clock.svg" alt="fxci" />
            ...
            <div className="model-page__rules-item card__1">
              <img className="card__1-img" src="/assets/img/icon-trending-up.svg" alt="fxci" />
          ...
          <div className="card__1-row">
            <div className="model-page__rules-item card__1">
              <img className="card__1-img" src="/assets/img/icon-roket.svg" alt="fxci" />
            ...
            <div className="model-page__rules-item card__1">
              <img className="card__1-img" src="/assets/img/icon-check-all.svg" alt="fxci" />
